...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
    ...
    themeConfig: {
        ...
        nav: [
            ...
            {
                text: '计算机基础',
                link: '/ComputerBasics/', //目录页链接，此处link是vdoing主题新增的配置项，有二级导航时，可以点击一级导航跳到目录页
                items: [
                    // 说明：以下所有link的值只是在相应md文件头部定义的永久链接（不是什么特殊编码）。另外，注意结尾是有斜杠的
                    {
                        text: '学习笔记',
                        items: [
                            {text: '《操作系统》笔记', link: '/note/os/'},
            ...
            },
            {
                ...
                link: '/database/',
                items: [
                    {text: 'MySQL', link: '/pages/a20ce8/'},
                    {text: 'Redis', link: '/pages/0dca32/'},
                ],
            },
            {
                text: '技术',
