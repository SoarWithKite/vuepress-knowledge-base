...
module.exports = {
    ...
    themeConfig: {
        nav: [
            ...
            {
                text: '数据库', link: '/pages/a20ce8/', items: [
                    {
                        text: 'MySQL', items: [
                            {text: 'MySQL的数据目录', link: '/pages/a20ce8/'},
                            {text: '逻辑架构', link: '/pages/f14bdb/'},
                            {text: '存储引擎', link: '/pages/3216b0/'},
                            {text: '索引的数据结构', link: '/pages/54651a/'},
                            {text: 'InnoDB的数据存储结构', link: '/pages/1cc523/'},
                            {text: '索引的创建与设计原则', link: '/pages/f51918/'},
                            {text: '性能分析工具的使用', link: '/pages/ce175c/'},
                            {text: '索引优化与查询优化', link: '/pages/4a1908/'},
                            {text: '数据库的设计规范', link: '/pages/d72f31/'},
                            {text: '数据库其他调优策略', link: '/pages/b29bc8/'},
                            {text: '事务基础知识', link: '/pages/f48e8d/'},
                            {text: 'MySQL事务日志', link: '/pages/ab7655/'},
                            {text: '锁', link: '/pages/c54d96/'},
                            {text: '多版本并发控制', link: '/pages/d44f30/'},
                            {text: '其他数据库日志', link: '/pages/9660c4/'},
                            {text: '数据库备份与恢复', link: '/pages/dc6fea/'},
